...
\begin{proof}
  ...
  \[
    \begin{tikzcd}
      ...
      & {Q \times Q} \ar[dl, swap, "\pi_1"] \ar[dr, "\pi_2"]&\\
      C_0 && C_0
    \end{tikzcd}
  \]
  to the square
  \[
    \begin{tikzcd}
      f^*(Q) \ar[d, swap, "f^*(v)"] \ar[r] & g^*(Q) \ar[d, "g^*(v)"]\\
      I \ar[r, swap, "\alpha"] & J
    \end{tikzcd}
  \]
  determined by the universal property of a pullback. We must now
  check that there is a unique correspondence between these two
  diagrams.
\end{proof}
