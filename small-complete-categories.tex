...
\begin{example}
  ...
  $(\partial_0 \circ \pi_1, \partial_1 \circ \pi_2)$ with the domain
  given by the pullback
  \[
    \begin{tikzcd}
      B_2 \ar[r] \ar[d] & B_1 \ar[d, "\partial_1"]\\
      B_1 \ar[r, swap, "\partial_0"] & B
    \end{tikzcd}
  \]
  Composition then is given as a morphism
  $\hom_{\Ccat/B \times B}(\pi_1^*(a) \times b_2, \pi_2^*(a))$
\end{example}
